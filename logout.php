...
if (isset($_SESSION['emailaddress']))
{
	...
	$sessid = session_id();
	?> <script>alert('You Are Successfully Log Out! Enjoy Your Day!');</script>
	<?php
...
?>
	 ...
	 <table   width="100%" style="background-color:#0080ff;color:white;margin-top:-775px;margin-left:-30px;max-width: 720px; height:30%; 
  min-width: 100%;       " cellspacing="0" cellpadding="2">
