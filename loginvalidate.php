...
$query = "SELECT email_address, password, complete_name FROM user_identities WHERE email_address like '" . $_POST['emailaddress'] . "' " .
...
if (mysqli_num_rows($result) == 1) {
	...
	while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
		...
		echo"<div id=\"aa\">";
		echo "Welcome <b>" . $complete_name . "</b><br>to Aliberti Online Shop . <br>"; 
	...
	echo"</div>";
				...
				<table   width="100%" style="background-color:#0080ff;color:white;margin-left:-45px;margin-top:-775px;max-width: 720px; height:30%; 
  min-width: 100%;       " cellspacing="0" cellpadding="2">
      ...
      <div class="modal-body">
        ...
        <div class="tab-pane fade" id="signup">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input id="address1" class="form-control" name="address1" pattern="[A-Za-z\s]{1-200}" type="text" title="Use Only Characters!" class="input-large" required="">
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input id="address2" class="form-control" name="address2" pattern="[A-Za-z\s]{1-200}" type="text" title="Use Only Characters!"  class="input-large" required="">
              </div>
            </div>
...
if (mysqli_num_rows($result) == 1) {
	?>
	<div id="wrapper_logval">
<h3 align="center"> Validate Session </h3>
<div id="main_content">
<?php
	?><script>alert('You are connected successfully!');</script>
	...
	while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
		...
		echo"<div id=\"aaa\">";
		echo "Hi customer <b>" . $complete_name . "</b> .You are connected successfully! Enjoy our Eshop! <br>";
		echo"</div>";
...
<script>alert('Please check your Email or Password!Not Logged in!');</script>
	
	<div align="center" style="position:absolute;top:120px;left:195px;">
