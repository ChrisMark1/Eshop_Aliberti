...
function comm1(){
	...
	function updateCart(){
		...
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			ajaxCart.innerHTML = xmlhttp.responseText + "  Items";
		}
	}
	xmlhttp.send(null);
}
...
$connect = mysqli_connect("localhost", "root", "", "customers") or die("Please, check your server connection.");
	...
	$result = mysqli_query($connect, $completename) or die(mysql_error()); 
		...
		{
?>
	<table   width="100%" style="background-color:#0080ff;color:white;margin-top:-44px;margin-left:-39px;max-width: 720px; height:30%; 
  min-width: 100%;      " cellspacing="0" cellpadding="2">
      ...
      <div class="modal-body">
        ...
        <div class="tab-pane fade" id="signup">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input id="email"  class="form-control" type="text" placeholder="JoeSixpack" name="emailaddress" class="input-large"  value="<?php if(isset($_POST['emailaddress'])) echo $_POST['emailaddress']; ?>" required="">
              </div>
            </div>
