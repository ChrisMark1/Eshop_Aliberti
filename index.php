...
<table   style="width:100%;margin: 0; padding: 0;margin-top:-5px;max-width: 720px;  min-width: 100%;      " cellspacing="0" cellpadding="2">
	<col style="width:28%">
	<col style="width:18%">
        	<col style="width:21%">
			<col style="width:23%">
...
$connect = mysqli_connect("localhost", "root", "", "customers") or die("Please, check your server connection.");
    ...
    $email_address= isset($_SESSION['emailaddress']) ;
	$completename= "SELECT complete_name FROM user_identities WHERE email_address='$email_address'";
	$result = mysqli_query($connect, $completename) or die(mysqli_error($connect)); 
		...
		echo"<div id=\"aa\">";
					echo "Welcome " . "<b>".($_SESSION['emailaddress']) . "</b>" . "&nbsp;&nbsp;&nbsp;" . "<br>to Aliberti Online Shop . <br>";
					echo"</div";
    ...
    margin: 0;
    padding: 0;background-color:#0080ff;color:white;margin-top:-44px;margin-left:-35px;max-width: 720px; ; 
...
<div class="modal fade bs-modal-sm" id="myModal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="tab-pane fade" id="signup">
            <form  name="frmRegistration" action="signupvalidate.php"  onSubmit="return validate_form(this);" method="post">
            <fieldset>
            <!-- Sign Up Form -->
            <!-- Text input-->
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input id="email"  class="form-control" type="text" placeholder="JoeSixpack" name="emailaddress" value="<?php if(isset($_POST['emailaddress'])) echo $_POST['emailaddress']; ?>" class="input-large" required="">
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input id="address1" class="form-control" pattern="[A-Za-z\s]{1-15}" title="Use Only Characters!" name="address1" type="text"  class="input-large" required="">
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input id="address2" class="form-control" pattern="[A-Za-z\s]{1-15}" title="Use Only Characters!" name="address2" type="text"  class="input-large" required="">
              </div>
            </div>
  ...
  <div id="aliberti_icon" style="position: center;margin: 0;
    padding: 0;  overflow-x: hidden;">
